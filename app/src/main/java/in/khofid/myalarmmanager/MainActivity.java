package in.khofid.myalarmmanager;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    final String TIME_PICKER_ONCE_TAG = "TimePickerOne";
    ...
    @Override
    public void onDialogDataSet(String tag, int year, int month, int dayOfMoth) {
